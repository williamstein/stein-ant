...
\section{The Problem}
\begin{center}
\includegraphics[width=20em]{graphics/spec}\\
...
\begin{minipage}{2in}
\mbox{}\vspace{3ex}
\includegraphics[width=1in]{graphics/gates}
\end{minipage}
\\
\end{tabular}
...
\psfrag{s}{$7\Z$}
\psfrag{t}{$11\Z$}
\includegraphics[width=30em]{graphics/cover1}\\
...
which we will prove in Chapter~\ref{ch:crt}.
...
a root of $f = x^5+7x^4+3x^2-x+1$.  According to \sage, the ring
...
$(1 - \eps)v + \eps v = v$, so that the sume
